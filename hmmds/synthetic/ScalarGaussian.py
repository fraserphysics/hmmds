...
mu = [-1.0, 1.0]
var = numpy.ones(2)
model_2a = hmm.base.HMM(P_S0, P_S0, P_SS, hmm.observe_float.Gauss(mu, var, rng), rng)
...
mu = [-2.0, 2.0]
var = numpy.ones(2)*2
model_2e = hmm.base.HMM(P_S0, P_S0, P_SS, hmm.observe_float.Gauss(mu, var, rng), rng)
...
model_3a = hmm.base.HMM(P_S0, P_S0, P_SS, hmm.observe_float.Gauss(mu, var, rng), rng)
