...
Figure~\ref{fig:ecg_hmm} illustrates the topology of the HMMs I built
...
simulated ECGs, eg, Figure~\ref{fig:simmulated}.
\begin{figure}
...
Figure~\ref{fig:c01c02_states} are sufficient for estimating heart
...
\subsection{An Observation Model for HMMs of Heart Rate}
