...
for each state being an affine \ToDo{Put \emph{affine} in the
  nomenclature.} function of the previous three observations and
variances fit to each state separately.  The models are one
dimensional versions of those described in
