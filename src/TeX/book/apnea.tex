...
\marginpar{ToDo: Use red for the plots on the right and on the left
  highlight the intervals in red.}
\begin{figure}
...
\marginpar{ToDO: Start at S1 and F1 in Fig.~\ref{fig:ecg_hmm}}
\begin{figure}
