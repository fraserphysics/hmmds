...
%
$\ti{\hat s}{t} = \argmax_{s'}P(\ti{s'}{t}|\ts{y}{1}{T}) =
...
of observations $\ts{y}{1}{6} = (a,b,b,b,b,c)$.  Any sequence of
states that is consistent with $\ts{y}{1}{6}$ must begin in $e$, end
...
$P(\ts{y}{1}{6},\ts{s}{1}{6})$ for all of the possible state
...
The next table displays the values of $P(\ti{s}{t}|\ts{y}{1}{6})$, the
a posteriori probability for the three possible states:
\begin{center}
  \begin{tabular}{cc|cccccc}
    &   & \multicolumn{6}{c}{$t$} \\
    \multicolumn{2}{r|}{$P(\ti{s}{t}|\ts{y}{1}{6})$}
        & 1 & 2 & 3 & 4 & 5 & 6 \\
    \hline
