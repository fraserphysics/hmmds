...
\fbox{
  \begin{minipage}{0.90\textwidth}
    \begin{tabbing}
      ...
      \end{minipage}\\ \\%
      %%
      \nomenclature[galphan]{$\bm{\alpha}_n$}{The set of conditional state
        probabilities based on the $n^{\text{th}}$ iteration of the
      ...
      %%
      \begin{minipage}[b]{1.0\textwidth}
        \nomenclature[gbetan]{$\bm{\beta}_n$}{The set of values based
          on the $n^{\text{th}}$ iteration of the Baum-Welch
          algorithm.}
        %
      ...
      %%
      \begin{minipage}[b]{1.0\textwidth}
        \nomenclature[ggamman]{$\bm{\gamma}_n$}{The set of conditional
          observation probabilities calculated based on the
          $n^{\text{th}}$ iteration of the Baum-Welch algorithm.}
        %
