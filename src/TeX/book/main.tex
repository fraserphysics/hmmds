...
were stumped\footnote{In subsequent years several good references that
  explain the basic ideas of HMMs have appeared, \eg, \ToDo{Find some}}.  A
...
\item[I provide code implementing the algorithms and data for the
  ...
  \ToDo{at \url{http://www.fraserphysics.com/~andy/hmmdsbook} and
    \url{www.siam.org/~fraser/XXXX}} I provide a working
  ...
  all of the figures in the text.  On \ToDo{What systems?}  issuing
