...
\begin{equation}
  ...
  P_{\ti{X}{2}|\ti{X}{0},\ti{X}{1}} = P_{\ti{X}{2}|\ti{X}{1}},
\end{equation}
which is equivalent to $\ti{X}{0}$ and $\ti{X}{2}$ being conditionally
independent given $\ti{X}{1}$, \ie,
\begin{equation*}
  P_{\ti{X}{2},\ti{X}{0}|\ti{X}{1}} = P_{\ti{X}{2}|\ti{X}{1}}   P_{\ti{X}{0}|\ti{X}{1}}.
\end{equation*}
...
\begin{align}
  ...
  \label{eq:sseqprob}%
  P_{\ts{S}{0}{T}}              &= P_{\ti{S}{0}} %
                                   \prod_{t=1}^{T-1} P_{\ti{S}{t}|\ti{S}{t-1}}\\
  \label{eq:condyseqprob}%
  P_{\ts{Y}{0}{T}|\ts{S}{0}{T}} &= \prod_{t=1}^{T-1} P_{\ti{Y}{t}|\ti{S}{t}}\\
  \intertext{and we conclude}
  P_{\ts{Y}{0}{T},\ts{S}{0}{T}} &= P_{\ti{S}{0}} %
                                   \prod_{t=1}^{T-1} P_{\ti{S}{t}|\ti{S}{t-1}}\, %
                                   \prod_{t=0}^{T-1} P_{\ti{Y}{t}|\ti{S}{t}}.\notag
\end{align}
...
\item[The Forward Algorithm:] For each time step $t$ and each state
  ...
  $P_{\ti{S}{t}|\ts{Y}{0}{t+1},\parameters} \left(s|\ts{y}{0}{t+1},
  ...
  \begin{equation*}
    P \left(\ts{y}{0}{T}|\parameters \right) =  P \left(\ti{y}{0}
      |\parameters \right) \cdot  \prod_{t=1}^{T-1} P
