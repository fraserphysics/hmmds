...
of integer valued observations $y_1^{\NLorenzBig}$ by dividing the $x_1$
...
that for each integer $1\leq t \leq \NLorenzBig$, $\ti{x_1}{t\cdot0.15}$
...
\end{description}
The results appear in Table~\ref{tab:POS}.\marginpar{FixMe: Revise
  upper table}
