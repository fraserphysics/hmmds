...
\begin{figure}[htbp]
  \centering{\plotsize%		% See the comment at the definition
    ...
    \def\Laser{Laser}%
    \def\Simulation{Simulation}% FixMe: useless defs here and elsewhere?
    \includegraphics{LaserLP5.pdf}}
...
\begin{figure}[htbp]
  \centering{\plotsize%
    ...
    \includegraphics{LaserLogLike.pdf}}
...
\begin{figure}[htbp]
  \centering{\plotsize%
    \includegraphics{LaserStates.pdf}}
...
\begin{figure}[htbp]
  \centering{\plotsize%
    ...
    \includegraphics{LaserForecast.pdf}}
...
In this section we describe the simplest HMMs: those that are discrete
in time, state, and observation.  We begin with a couple of
