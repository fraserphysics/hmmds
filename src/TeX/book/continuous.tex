...
%%   P\left(\ti{x}{t}|\ts{y}{0}{t} \right) d\ti{x}{t} \\
  \label{eq:IFore}
  &= \int P \left(\ti{x}{t+1}|\ti{x}{t} \right)
...
\item \label{PXforecast} \textbf{Calculate the state forecast,
  ...
  $\EV_{\ti{X}{t-1},\ti{\eta}{t}|\ts{y}{0}{t}}$?}\marginPar{Check t-1}
  \begin{align}
    \ti{\mu_a}{t} &= \EV_{P
