...
FixMe: All defs in fig:ScalarGaussian should be read from a file
written by scalar\_gaussian.py
%%%
%%% fig:ScalarGaussian
%%%
\begin{figure}[htbp]
...
\end{figure} \marginpar{FixMe: Two rather than six.  Get data from scalar\_gaussian.py}
...
\marginpar{FixMe: No empty boxes.  Try other random seeds to get
  ``large regions near the fixed points.''}
