...
\item[Reestimation] Reviewing the derivations in Section
  ...
  $P_{\ti{S}{1}\given \ti{\parameters}{n+1}} \left(i\given \ti{\parameters}{n+1} \right)$, 
  and the state transition probability,
  $P_{\ti{S}{t+1}\given \ti{S}{t},\ti{\parameters}{n+1}} \left({\tilde s}\given s \right)$) 
...
\begin{align}
  ...
  \left(\ts{q}{0}{T}\given \ts{y}{0}{T} \right) \sum_{t=1}^T
