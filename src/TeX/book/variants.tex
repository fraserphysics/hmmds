...
\begin{align}
  ...
  P(\ti{s}{t}|\ts{s}{-\infty}{t},\ts{y}{-\infty}{t}) &= 
  P\left(\ti{s}{t}|\ti{s}{t-1}\right)\\
  \label{eq:assume_outputVARG}
  P(\ti{y}{t}|\ts{s}{-\infty}{t+1},\ts{y}{-\infty}{t}) &=
...
\item[Particle filter] The idea of using the empirical distribution of
  ...
  conditional distribution $P_{\ti{X}{t}|\ts{Y}{0}{t+1}}$ is called
