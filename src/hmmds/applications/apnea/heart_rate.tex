...
\begin{figure}
  \centering
    \resizebox{0.8\textwidth}{!}{\includegraphics{norm_prominence_study.pdf}}
    \caption{Like \ref{fig:prominence_study} but for models with
      \textbf{normalized} heart rate signals.}
...
\begin{figure}
  ...
  \caption{Like Fig.~\ref{fig:power_threshold} but for a model with
    \textbf{normalized} heart rate signals.}
...
\begin{figure}
  ...
  \resizebox{0.8\textwidth}{!}{\includegraphics{norm_errors_vs_ar_order.pdf}}
    \caption{Like Fig.~\ref{fig:errors_vs_ar_order} but for models
      with \textbf{normalized} heart rate signals.}
...
\begin{table*}
  ...
  \caption[Performance]{Like Table~\ref{tab:score_initial} but for a
    model with \textbf{normalized} heart rate signals.}
...
\begin{itemize}
\item Include results of multi-chain and normalized multi-chain models
  in this document.
