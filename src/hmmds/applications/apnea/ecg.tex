...
put in the next inter-beat interval.  Varying the AR order didn't
help.  In fact AR1 misses every other beat.  I found that reducing the
number of slow states helped.  My guess is that with fewer slow
states, the output models for those states have larger variance and
are thus happy to absorb the high noise periods.
...
\item Eliminate Funny and Implausible stuff
