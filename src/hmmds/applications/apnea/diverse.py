"""diverse.py Modification of explore.py that reads results from diverse_states and diverse_likelihood
...
class MainWindow(PyQt5.QtWidgets.QMainWindow):
    ...
    def read_viterbi(self):
        ...
        path = os.path.join(self.root_box.text(),
                            ...
                            f'{self.ecg_hmm_box.text()}', 'diverse_states',
    ...
    def read_like(self):
        path = os.path.join(self.root_box.text(),
                            'build/derived_data/apnea/models',
                            f'{self.ecg_hmm_box.text()}', 'diverse_likelihood',
                            self.record_box.text())
        with open(path, 'rb') as _file:
