...
%    \input{gaussmixA.pdf_t}\\[-2.5ex]
%    \input{gaussmix.pdf_t}
  }
...
%        \input{SGO.pdf_t}
      ...
      \end{picture}%
      \hspace{2em}
%      \resizebox{0.4\textwidth}{!}{\includegraphics{SGOsimS.pdf}}
      % 
      %\smallskip%
      \\
      \begin{picture}(0,0)
      ...
      \end{picture}%
      \hspace{2em}
%      \resizebox{0.4\textwidth}{!}{\includegraphics{SGOsimY.pdf}}%
      \smallskip%
      &
      \begin{picture}(0,0)
        \put(0.0,0.8){\makebox{\normalsize\textbf{(d)}}}
      \end{picture}%
      \hspace{2em}
%      \resizebox{0.4\textwidth}{!}{\includegraphics{SGOdecodeS.pdf}}%
      %\smallskip%
      \\
      \begin{picture}(0,0)
        \put(-0.1,0.8){\makebox{\normalsize\textbf{(e)}}}
...
\begin{figure}[htbp]
  \centering{
%    \resizebox{\textwidth}{!}{\includegraphics{ToyTS.pdf}}
  }
...
\begin{figure}
  ...
  \label{fig:sgram}
\end{figure}
\afterpage{\clearpage} % Flush floate
\newpage
...
\begin{figure}[htbp]
  \begin{center}
    ...
    {\textbf{This algorithm does not work!}  In the book, this
    figure was entitled \emph{Pseudocode for the Viterbi Algorithm}.}
    \label{fig:viterbiC}
  \end{center}
\end{figure}
...
\begin{figure}[tbhp]
  \centering{
%      \resizebox{\textwidth}{!}{\includegraphics{class1.pdf}}
  }
...
package.  If you want to build the data, simply remove data/PFsurveyH,
make data/PFsurveyH and copy it to data/PFsurvey.
\begin{figure}
  \centering{
