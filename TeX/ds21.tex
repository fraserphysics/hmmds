...
\frame{ \frametitle{New Text and Software for Book (2)}
  Progress on new code after Lo Alamos:\medskip\\
  \begin{description}
...
Since I quit Los Alamos National Laboratory in September, one of my
goals has been revising the text and code for my book ``Hidden
...
the consensus was that there was not a good resource.
...
A subset of the speakers in 2001 agreed to write a book.
...
Vixie's dissertation.  I also got a lot of help organizing the code
and figures for the book from Karl Hegbloom.
...
In the past 20 years scientific computing with Python has improved and
so have my ideas about readability.

The shortcomings of the original code included:

* The Makefile was hard to read.  While the make utility automates and
documents a build process adequately, I wish it was easier or even
...
The worst was that instead of using a version control tool, scientists
were emailing versions of code back and forth.

I began thinking about how to teach modern software practices.

I planned to formally teach summer students and then, on the side,
suggest the lessons to colleagues.
...
lessons that he and a colleague gave at Los Alamos.  They gave those
lessons several times between 1998 and 2002.
...
from experience teaching Software Carpentry.

The paper hits all the right points with the right emphasis.  Here are
the 8 main points from the paper.  (I've used red to emphasize key
...
5.  I ended up organizing a team of instructors at Los Alamos who now
offer Software Carpentry Workshops a few times every year.

The experience has helped me formulate goals for new versions of the
text and software for the book.
...
while going to The Lab every day, but since I left Los Alamos, I've
made a good start.
...
the apnea classification example.

7. There was a contest in 2000 to use only electro-cardiogram data to
determine when patients were having episodes of obstructive sleep
apnea.
...
Oxygen saturation is constant and above 90\%.  And the heart rate is
constant.
...
That's even though the total probability assigned to the apnea modes
combined is larger than the probability assigned to the normal mode.

9. I've tried several different approaches for using heart rate data
to estimate class (meaning apnea or normal).
...
My old code aimed to produce exactly such a Maximum A-posteriori
Probability estimate with a linear computational expense.  It's too
bad that it's not possible.
