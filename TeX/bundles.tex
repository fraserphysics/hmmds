...
\label{sec:forward}
\index{forward algorithm|textbf} \marginpar{Diane, I only include the
...
spectrograms\footnote{A spectrogram is display of power in Fourier
  ...
  time.} to visualize the data.  \index{spectrogram} In preparing the
...
\section{First Classification Algorithms}
\label{sec:NVG}
